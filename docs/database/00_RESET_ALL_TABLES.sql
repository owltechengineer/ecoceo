-- =====================================================
-- RESET COMPLETO DATABASE - ELIMINA E RICREA TUTTO
-- =====================================================
-- ATTENZIONE: Questo script elimina TUTTE le tabelle esistenti
-- e le ricrea da zero. Usare solo per reset completo.
-- =====================================================

-- 1. ELIMINA TUTTE LE TABELLE ESISTENTI (in ordine per evitare foreign key constraints)
-- =====================================================

-- Elimina tabelle con foreign key per prime
...
-- 2. RICREA TUTTE LE TABELLE (in ordine corretto)
-- =====================================================
...
-- 4. CREA POLICY RLS (Row Level Security)
-- =====================================================
...
-- =====================================================
-- Tutte le tabelle sono state eliminate e ricreate
-- con trigger, policy RLS e dati di esempio
-- =====================================================
