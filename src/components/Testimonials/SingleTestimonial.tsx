...
const SingleTestimonial = ({ testimonial }: { testimonial: Testimonial }) => {
  ...
  return (
    <div className="w-full">
      <div className="shadow-two hover:shadow-one dark:bg-dark dark:shadow-three dark:hover:shadow-gray-dark rounded-xs bg-white/30 backdrop-blurp-8 duration-300 lg:px-5 xl:px-8">
