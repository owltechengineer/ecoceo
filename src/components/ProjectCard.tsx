...
export default function ProjectCard({ project, services, onEdit, onDelete }: ProjectCardProps) {
  ...
  return (
    <div className="bg-white/30 backdrop-blur/30 backdrop-blur/20 backdrop-blur-md rounded-xl shadow-lg border border-white/30 hover:shadow-xl hover:bg-white/30 backdrop-blur/30 backdrop-blur/30 transition-all duration-300 mb-6">
      {/* Header principale */}
      <div className="p-8">
      ...
      {isExpanded && (
        <div className="border-t border-white/30 bg-white/30 backdrop-blur/30 backdrop-blur/10 backdrop-blur-sm p-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Dettagli temporali */}
            <div className="bg-white/30 backdrop-blur/30 backdrop-blur/30 backdrop-blur-sm rounded-lg p-6 shadow-sm border border-white/40">
