...
export default function DashboardNavigation({ activeSection = 'dashboard', onSectionChange }: DashboardNavigationProps) {
  ...
  return (
    <div className="bg-white/30 backdrop-blur/30 backdrop-blurrounded-xl shadow-lg border border-gray-100 p-6">
      <div className="mb-6">
          ...
          >
            <div className="flex items-start space-x-4">
              <div className={`p-3 rounded-lg ${
                activeSection === item.key
                  ? 'bg-white/30 backdrop-blur/30 backdrop-blurbg-opacity-20'
