    ...
    <div className="bg-white/30 backdrop-blurrounded-lg shadow-sm p-6">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-100 p-4 rounded-lg">
          ...
          <pre className="text-sm whitespace-pre-wrap max-h-96 overflow-y-auto text-gray-900 bg-white/30 backdrop-blurp-3 rounded border">{debugResult || 'Nessun test eseguito'}</pre>
        </div>
