...
async function populateWarehouseData() {
  ...
  try {
    // 1. Inserisci categorie magazzino
    ...
    // 2. Inserisci posizioni magazzino
    ...
    if (locationsError) {
      ...
      console.log('✅ Posizioni inserite:', locations.length);
    }

    // 3. Inserisci articoli magazzino
    ...
    if (itemsError) {
      ...
      console.log('✅ Articoli inseriti:', items.length);
    }
